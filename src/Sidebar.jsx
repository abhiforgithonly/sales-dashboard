      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 lg:py-6 overflow-y-auto custom-scrollbar">
          ...
          <div className="mb-6 lg:mb-8">
            <button className="w-full flex items-center gap-3 px-3 py-2 lg:py-2.5 text-sm text-gray-600 hover:bg-gray-50 rounded-lg transition-colors group">
          ...
          {!collapsed && (
            <>
              ...
              <button className="w-full flex items-center gap-3 px-3 py-2.5 lg:py-3 mb-6 lg:mb-8 text-sm font-medium bg-pink-500 text-white rounded-dashboard-sm shadow-sm hover:bg-pink-600 transition-all duration-200 hover-lift">
              ...
              <div className="mb-6 lg:mb-8">
                ...
                <button 
                  className="w-full flex items-center justify-between px-3 py-2 lg:py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-dashboard-sm transition-colors group"
                ...
                {codenameOpen && (
                  <div className="ml-6 mt-2 space-y-1">
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Cargo2go</button>
                    <button className="w-full flex items-center justify-between px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">
                      <span>Cloudz3r</span>
                      <span className="w-5 h-5 bg-pink-500 rounded text-white text-xs flex items-center justify-center font-semibold">2</span>
                    </button>
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Idioma</button>
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Syllables</button>
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">x-0b</button>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                {reportsOpen.shared && (
                  <div className="ml-6 mt-2 space-y-1">
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Deals by user</button>
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Deal duration</button>
                  </div>
                )}

                <button 
                  className="w-full flex items-center justify-between px-3 py-2 lg:py-2.5 mt-3 text-sm text-gray-700 hover:bg-gray-50 rounded-dashboard-sm transition-colors group"
                ...
                {reportsOpen.myReports && (
                  <div className="ml-6 mt-2 space-y-1">
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Emails received</button>
                    <button className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">Deal duration</button>
                    <button className="w-full text-left px-3 py-2 text-sm text-pink-500 font-semibold hover:bg-gray-50 rounded-dashboard-sm transition-colors">New report</button>
                    <button className="w-full flex items-center justify-between px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors">
                      <span>Analytics</span>
                      <span className="w-5 h-5 bg-pink-500 rounded text-white text-xs flex items-center justify-center font-semibold">2</span>
                    </button>
                ...
                <button className="w-full flex items-center gap-3 px-3 py-2 lg:py-2.5 mt-6 text-sm text-gray-600 hover:bg-gray-50 rounded-dashboard-sm transition-colors group">
